...
GBLasso_simulation <- function(gamma = 2, epsilon=0.01, ksi=0.01, simTimes=100 ){
 ...
 #   simData = simulateData(simSeed,0)
    ...
    res_D_G=NetworkRegression_GBLasso(Ytr, Xtr, netwk, gamma, degree^gamma, epsilon, ksi, MAXITER=1000, MAXLOOP=10000)
    ...
    # resEB_D_G=NetworkRegression_GBLasso_EB(Ytr, Xtr, netwk, gamma, degree^gamma, epsilon, ksi, MAXITER=1000, MAXLOOP=5000)
    ...
    resEB_WS_G=NetworkRegression_GBLasso(Ytr, Xtr, netwk, gamma, weightSum^gamma, epsilon, ksi, MAXITER=1000, MAXLOOP=10000)
    # resEB_WS_GS=NetworkRegression_GBLasso(Ytr, Xtr, netwk, gamma, weightSum^((gamma+1)/2), epsilon, ksi, MAXITER=1000, MAXLOOP=10000)
    
    
    # source("/media/hx239/Disk1/projects/GBLasso/GBLasso_code/NetworkRegression_GBLasso_EBsqrt.R")
